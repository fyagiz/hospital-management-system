...
char Menu::showMenu(char command, Hospital *hospital){
...
void Menu::getEmployeeInfo(Employee *tmpEmployee){
...
void Menu::addNewDoctor(Team *tmpTeam){
...
void Menu::addNewNurse(Team *tmpTeam){
...
void Menu::addNewAdmin(Team *tmpTeam){
